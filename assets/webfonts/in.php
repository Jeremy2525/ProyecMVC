        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            ...
            <div class="col-lg-6 col-5 text-right">
              <a href="#" class="btn btn-sm btn-neutral">Nuevo</a>
              ...
              <div class="card card-stats">
                ...
                <div class="card-body">
                  ...
                  <p class="mt-3 mb-0 text-sm">
                    ...
                    <span class="text-nowrap">Actual</span>
                  </p>
                </div>
              </div>
            </div>
            <div class="col-xl-3 col-md-6">
              <div class="card card-stats">
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      <h5 class="card-title text-uppercase text-muted mb-0">Nuevo Usuario</h5>
            ...
            <div class="col-xl-3 col-md-6">
              <div class="card card-stats">
                ...
                <div class="card-body">
                  ...
                  <p class="mt-3 mb-0 text-sm">
                    <span class="text-success mr-2"><i class="fa fa-arrow-up"></i> 3.48%</span>
                    <span class="text-nowrap">Semana Pasada</span>
                  </p>
                </div>
              </div>
            </div>
        ...
        <div class="col-xl-4">
          <div class="card">
            <div class="card-header bg-transparent">
              <div class="row align-items-center">
                <div class="col">
                  <h5 class="h3 mb-0">Ordenes Pendientes</h5>
                </div>
              </div>
            </div>
            <div class="card-body">
                  ...
                  <div class="row align-items-center">
                    <div class="col-auto">
                      ...
                      <a href="#" class="avatar rounded-circle">
                        <img alt="Image placeholder" src="<?=URL?>assets/images/admin/cliente/team-1.jpg">
                      </a>
                    </div>
                    <div class="col ml--2">
                      <h4 class="mb-0">
                ...
                <li class="list-group-item px-0">
                  <div class="row align-items-center">
                    <div class="col-auto">
                      <!-- Avatar -->
                      <a href="#" class="avatar rounded-circle">
                        <img alt="Image placeholder" src="<?=URL?>assets/images/admin/cliente/team-2.jpg">
                      </a>
                    </div>
                    <div class="col ml--2">
                      <h4 class="mb-0">
                ...
                <li class="list-group-item px-0">
                  <div class="row align-items-center">
                    <div class="col-auto">
                      <!-- Avatar -->
                      <a href="#" class="avatar rounded-circle">
                        <img alt="Image placeholder" src="<?=URL?>assets/images/admin/cliente/team-3.jpg">
                      </a>
                    </div>
                    <div class="col ml--2">
                      <h4 class="mb-0">
          ...
          <div class="card">
            ...
            <div class="card-header d-flex align-items-center">
              <div class="d-flex align-items-center">
                <a href="#">
                  <img src="<?=URL?>assets/images/admin/cliente/team-1.jpg" class="avatar">
                </a>
                <div class="mx-3">
                  <a href="#" class="text-dark font-weight-600 text-sm">Jhon Snow</a>
            ...
            <div class="card-body">
              ...
              <img alt="Image placeholder" src="<?=URL?>assets/images/admin/img-1-1000x600.jpg" class="img-fluid rounded">
                  ...
                  <div class="d-flex align-items-center justify-content-sm-end">
                    <div class="avatar-group">
                      <a href="#" class="avatar avatar-xs rounded-circle" data-toggle="tooltip" data-original-title="Jessica Rowland">
                        <img alt="Image placeholder" src="<?=URL?>assets/images/admin/cliente/team-1.jpg" class="">
                      </a>
                      <a href="#" class="avatar avatar-xs rounded-circle" data-toggle="tooltip" data-original-title="Audrey Love">
                        <img alt="Image placeholder" src="<?=URL?>assets/images/admin/cliente/team-2.jpg" class="rounded-circle">
                      </a>
                      <a href="#" class="avatar avatar-xs rounded-circle" data-toggle="tooltip" data-original-title="Michael Lewis">
                        <img alt="Image placeholder" src="<?=URL?>assets/images/admin/cliente/team-3.jpg" class="rounded-circle">
                      </a>
                    </div>
              ...
              <div class="mb-1">
                <div class="media media-comment">
                  <img alt="Image placeholder" class="avatar avatar-lg media-comment-avatar rounded-circle" src="<?=URL?>assets/images/admin/cliente/team-1.jpg">
                ...
                <div class="media media-comment">
                  <img alt="Image placeholder" class="avatar avatar-lg media-comment-avatar rounded-circle" src="<?=URL?>assets/images/admin/cliente/team-2.jpg">
                  <div class="media-body">
                    <div class="media-comment-text">
                ...
                <div class="media align-items-center">
                  <img alt="Image placeholder" class="avatar avatar-lg rounded-circle mr-4" src="<?=URL?>assets/images/admin/cliente/team-3.jpg">
                  <div class="media-body">
                    <form>
              ...
              <div class="card-body">
                ...
                <div class="row">
                  <div class="col">
                    ...
                    <span class="d-block h3 text-white">Jhon Snow</span>
                  </div>
                </div>
              </div>
            </div>
